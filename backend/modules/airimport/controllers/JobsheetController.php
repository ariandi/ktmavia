...
use backend\modules\airimport\models\JobsheetSearch;
...
use backend\modules\airimport\models\Invoice;
use backend\modules\airimport\models\InvoiceDetail;
use backend\modules\airimport\models\Debitnote;
use backend\modules\airimport\models\Debitnotedet;
use backend\modules\airimport\models\Creditnote;
use backend\modules\airimport\models\Creditnotedet;
...
class JobsheetController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if(Yii::$app->request->post('makeinvo') == 1){
            ...
            $vinvoice->invoice_no     = $nol.'/KTM-AI/'.strtoupper(date('M')).'/'.date('Y');
			...
			/*End Credit Note*/
                    ...
                    return $this->redirect(['/airimport/invoice']);
