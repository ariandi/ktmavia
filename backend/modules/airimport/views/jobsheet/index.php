...
/* @var $searchModel backend\modules\airimport\models\JobsheetSearch */
        ...
        'columns' => [
            ...
            'buttons' => [
                    'link' => function ($url,$data,$key) {
                            return Html::a('<span class="glyphicon glyphicon-th-list"></span>', ['/airimport/jobsheetdet/detailq', 'id'=>$data->jobs_id]);
                    },
                    'view' => function ($url,$data){
                            $url = '/airimport/jobsheet/jobsheetview/';
