...
class BilllandingSearch extends Billlanding
{
    ...
    {
        return [
            [['bl_id', 'si_id', 'quotationid', 'notify_party', 'delivery_agent', 'active', 'update_by', 'insert_by'], 'integer'],
            [['bl_number', 'bl_place', 'bl_date', 'bl_type', 'ocean_vessel', 'port_of_discharge', 'place_of_receipt', 'port_of_loading', 'place_of_delivery', 'rate', 'freight_term', 'currency', 'prepaid_at', 'payable_at', 'number_of_original', 'status', 'initial_carriage', 'update_date', 'insert_date', 'collect', 'shipper', 'consignee'], 'safe'],
