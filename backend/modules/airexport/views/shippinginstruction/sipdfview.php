...
<div style="margin:0 auto;width:690px; margin-top:20px;" class="wrapperpdf">
	...
	<table class="t2">
		...
		<tr>
				...
				<td>AIR LINES</td>
				<td width="10"></td>
				<td class="model"><?=$model->vessel?></td>
		</tr>
	</table>
	...
	<table class="t2" border="1">
		<tr>
				...
				<td style="border:1pt solid black;" width="10">:</td>
		...
		<tr>
				<td class="no-bottom-border">FLIGHT NO</td>
				<td>:</td>
				<td class="model no-bottom-border"><?=$model->stucking?></td>
