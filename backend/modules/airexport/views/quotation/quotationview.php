		...
		<thead>
				...
				<th colspan="2">
					<table class="tabel2" width="100%" border="1">
						...
						<tr >
							...
							<td class="w20 uppercase">Pege</td>
			...
			<tr>
				<td colspan="2" class="contenq">
					...
					<br />
					<p>
					We would like to inform you our best rate to support your export as you can read as follow : 
					</p>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" class="contenq2">
					<table class="table3" width="70%" border="0">
						<tr >
							<td class="w35 uppercase">Airport Departure</td>
			...
			<tr>
				<td colspan="2" class="contenq3">
					<table class="table3" width="70%" border="0">
						...
						<tr>
							<td colspan="7"><hr class="table3-hr" /></td>
						</tr>
						<?php 
