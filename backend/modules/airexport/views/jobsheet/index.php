...
/* @var $searchModel backend\modules\airexport\models\JobsheetSearch */
        ...
        'columns' => [
            ...
            'buttons' => [
                    'link' => function ($url,$data,$key) {
                            return Html::a('<span class="glyphicon glyphicon-th-list"></span>', ['/airexport/jobsheetdet/detailq', 'id'=>$data->jobs_id]);
                    },
                    'view' => function ($url,$data){
                            $url = '/airexport/jobsheet/jobsheetview/';
