...
<div style="margin:0 auto;width:760px; margin-top:20px;" class="wrapperpdf">
	...
	<div style="border:2px solid;padding:10px;border-bottom:none;">
		...
		<div>
			<?=$model->jobsheetinfo->companyname?><br />
			<?=$model->jobsheetinfo->deliveryaddress?><br />
			<?='Tel : '.$model->jobsheetinfo->phone.', Fax : '.$model->jobsheetinfo->fax?>
		</div> 
	</div>
	...
	<div style="border:2px solid;border-bottom:none;">
		<div style="width:450px;float:left;border-right:2px solid;padding:10px;">
			...
			<div>
				...
				<div style="width:25px;float:left;"> : </div>
				<div style="width:200px;float:left;"><?=$model->jobsheetinfo2->hbl?></div>
			</div>
			<div>
				<div class="uppercase" style="width:150px;float:left;">POL / POD</div>
				<div style="width:25px;float:left;"> : </div>
				<div style="width:250px;float:left;"><?=$model->jobsheetinfo2->billlanding->place_of_receipt.' / '.$model->jobsheetinfo2->destination?></div>
			</div>
			<div>
				<div class="uppercase" style="width:150px;float:left;">VESSEL / FLIGHT NAME</div>
				<div style="width:25px;float:left;"> : </div>
				<div style="width:200px;float:left;"><?=$model->jobsheetinfo2->billlanding->ocean_vessel?></div>
			</div>
			<div>
				<div class="uppercase" style="width:150px;float:left;">COMMODITY</div>
				<div style="width:25px;float:left;"> : </div>
				<div style="width:200px;float:left;"><?=$model->jobsheetinfo2->commodity?></div>
			</div>
			<div>
	...
	<div style="border:2px solid;border-bottom:none;">
		<div style="width:30px;float:left;padding:5px;border-right:2px solid;" class="uppercase">
			No
		</div>
	...
	<div style="border:2px solid;border-bottom:none;">
		...
		<div style="width:400px;float:left;padding:5px;border-right:2px solid;text-align:center;border-top:2px solid;" class="uppercase">
			Total
		</div>
	...
	<div style="border:2px solid;">
		...
		<div style="padding:5px;" class="uppercase">
			<?=$terbilang?> Rupiah.
		</div>
