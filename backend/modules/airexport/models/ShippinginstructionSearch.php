...
/**
 * ShippinginstructionSearch represents the model behind the search form about `backend\modules\airexport\models\Shippinginstruction`.
 */
class ShippinginstructionSearch extends Shippinginstruction
{
    ...
    {
        return [
            [['si_id', 'topic', 'frompic', 'attn', 'shipper', 'consignee', 'notify_party', 'insertby', 'updateby', 'active', 'quotationid', 'kindofexport'], 'integer'],
            [['no_ref', 'date', 'booking_number', 'depo', 'stucking', 'telp_fax', 'email', 'vessel', 'connecting_vessel', 'port_of_loading', 'etd_jkt', 'eta_pus', 'via_transit', 'etd_pus', 'quantity', 'freight_term', 'stuffing', 'gw_nw_cbm', 'description_good', 'cont_seal_no', 'shipping_mark', 'destination', 'rate', 'note', 'peb_no', 'tgl', 'kpbc', 'hs_code', 'bl_no', 'insertdate', 'updatedate', 'status', 'eta_pod'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'eta_pod' => $this->eta_pod,
            'shipping_instruction.kindofexport' => 3,
        ]);
