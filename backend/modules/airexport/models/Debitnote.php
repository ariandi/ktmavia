...
class Debitnote extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['invoice_no', 'bl_id', 'insert_by', 'insert_date', 'invoice_id'], 'required'],
            [['invoice_date', 'due_date', 'insert_date', 'update_date', 'jobs_id'], 'safe'],
            [['jobs_id', 'bl_id', 'companyid', 'insert_by', 'update_by', 'active', 'invoice_id', 'kindofexport'], 'integer'],
            [['tot_amount'], 'number'],
            [['status'], 'string'],
