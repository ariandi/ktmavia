...
use backend\modules\airexport\models\QuotationSearch;
...
use backend\modules\airexport\models\Quotationdetail;
...
class QuotationController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if(Yii::$app->request->post('makesi') == '1'){
            ...
            $shippinginstruction->no_ref        = $nol.'/KTM-AE/'.strtoupper(date('M')).'/'.date('Y');
            ...
            $shippinginstruction->consignee     = 1;
            ...
            $shippinginstruction->kindofexport  = 3;
            $shippinginstruction->status        = 'PENDING';
            
            if($shippinginstruction->save()){
                return $this->redirect(['/airexport/shippinginstruction']);
            }else{
