...
use backend\modules\airexport\models\JobsheetSearch;
...
class JobsheetController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if(Yii::$app->request->post('makeinvo') == 1){
            ...
            $vinvoice->invoice_no     = $nol.'/KTM-AE/'.strtoupper(date('M')).'/'.date('Y');
			...
			/*End Credit Note*/
                    ...
                    return $this->redirect(['/airexport/invoice']);
