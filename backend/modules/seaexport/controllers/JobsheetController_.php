...
use backend\modules\seaexport\models\JobsheetSearch;
...
use backend\modules\seaexport\models\Debitnote;
use backend\modules\seaexport\models\Debitnotedet;
use backend\modules\seaexport\models\Creditnote;
use backend\modules\seaexport\models\Creditnotedet;
    ...
    public function actionUpdate($id)
    {
        ...
        if(Yii::$app->request->post('makeinvo') == 1){
			...
			foreach ($modeldbn as $mdbn) {
                    		$exbillship2 = explode(' / ', $mdbn->bill_cost);
                    		$rows2[] = [
			...
			foreach ($modelcrn as $mcrn) {
                    		$exbillship3 = explode(' / ', $mcrn->bil_agent);
                    		$rows3[] = [
			...
			/*End Credit Note*/
                    ...
                    return $this->redirect(['/seaexport/invoice']);
