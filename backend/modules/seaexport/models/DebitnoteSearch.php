...
/**
 * DebitnoteSearch represents the model behind the search form about `backend\modules\seaexport\models\Debitnote`.
 */
class DebitnoteSearch extends Debitnote
{
    ...
    {
        return [
            [['debitnote_id', 'bl_id', 'companyid', 'insert_by', 'update_by', 'active', 'invoice_id'], 'integer'],
