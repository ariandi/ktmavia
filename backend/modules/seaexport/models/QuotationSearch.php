...
class QuotationSearch extends Quotation
{
    ...
    {
        return [
            [['quotationid', 'createby', 'updateby', 'active'], 'integer'],
            [['quotationtitle', 'quotationdate', 'senderreerence', 'createdate', 'updatedate', 'status','portofloading', 'picto', 'picfrom', 'companyid'], 'safe'],
        ];
    }
