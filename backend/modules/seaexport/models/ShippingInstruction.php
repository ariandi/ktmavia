...
class ShippingInstruction extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['no_ref', 'topic', 'frompic', 'telp_fax', 'email', 'shipper', 'consignee', 'notify_party', 'freight_term', 'quotationid'], 'required'],
            [['date', 'etd_jkt', 'eta_pus', 'stuffing', 'tgl', 'insertdate', 'updatedate', 'eta_pod'], 'safe'],
            [['topic', 'frompic', 'attn', 'shipper', 'consignee', 'notify_party', 'insertby', 'updateby', 'active', 'quotationid'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'vessel' => 'Vessel',
            'connecting_vessel' => 'Connecting Vessel',
