...
/**
 * JobsheetSearch represents the model behind the search form about `backend\modules\seaexport\models\Jobsheet`.
 */
class JobsheetSearch extends Jobsheet
{
    ...
    public function rules()
    {
        return [
            ...
            [['jobs_name', 'date', 'jobs_no', 'commodity', 'po_sty', 'ctn_qty', 'dimensions', 'destination', 'freight', 'date_rcvd', 'telp_fax', 'gross_w', 'vol_w', 'measurement', 'overseas_agent', 'handling', 'mbl', 'hbl', 'fl', 'remarks', 'handling_by', 'remarks2', 'pickup', 'delivery', 'status', 'insert_date', 'update_date', 'prepain_by', 'approve_by', 'shipper', 'consignee'], 'safe'],
        ];
    }
