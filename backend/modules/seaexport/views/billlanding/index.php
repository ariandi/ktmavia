...
<div class="billlanding-index">
    ...
    <h1 style="margin-top:0px;"><?= Html::encode('Bill of Landing') ?></h1>
    <br />
        ...
        'columns' => [
            ...
            'buttons' => [
                    'link' => function ($url,$data,$key) {
                            $url = '/wedew/wedew';
                            return Html::a('<span class="glyphicon glyphicon-th-list"></span>', ['/seaexport/billlandingdetail/detailq', 'id'=>$data->bl_id]);
                    },
                    'view' => function ($url,$data){
                            $url = '/seaexport/billlanding/billlandingview/';
