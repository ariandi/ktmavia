...
/* @var $searchModel backend\modules\seaexport\models\ShippingInstructionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Shipping Instructions';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="shipping-instruction-index">

    <h1 style="margin-top:0px;"><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?php //echo Html::a('Create Shipping Instruction', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
