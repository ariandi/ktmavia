		...
		<thead>
			...
			<tr>
				<th colspan="2">
					<table class="tabel2" width="100%" border="1">
						<tr >
							<td class="w20">To</td>
							<td class="w30"><?=$model->topic['FirstName'].' '.$model->topic['LastName'];?></td>
							<td class="w20">From</td>
							<td class="w30"><?=$model->frompic['FirstName'].' '.$model->frompic['LastName'];?></td>
						</tr>
						<tr >
							<td class="w20">Company</td>
							<td class="w30"><?=$model->company['companyname']?></td>
							<td class="w20">Date</td>
							<td class="w30"><?=$model->quotationdate?></td>
						</tr>
						<tr >
							<td class="w20">Phone Number</td>
							<td class="w30"><?=$model->company['phone']?></td>
							<td class="w20">Fax Number</td>
							<td class="w30"><?=$model->company['fax']?></td>
						</tr>
						<tr>
							<td class="w20">Title</td>
							<td class="w30"><?=$model->quotationtitle?></td>
							<td class="w20">Page</td>
							<td class="w30">1</td>
						</tr>
					</table>
				</th>
			...
			<tr>
				<td colspan="2" class="contenq">
					...
					<p class="uppercase">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						RE : <span style="font-weight:bold;" class="uppercase"> Quotation Export Rate FCL</span>
					</p>
					<br /><br />
					<p>
					Dear Sir & Madam,
					...
					<br />
					<p>
					We would like to inform you our best rate to support your shipment from jakarta to
					several destinations as you can read as follow : 
					</p>
				</td>
			</tr>
