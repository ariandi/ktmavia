...
<div class="wrapper">
	...
	<aside class="main-sidebar">
      ...
      $actionid == 'quotation--index' ? $dasboard_e = 'active':$dasboard_e = '';
      $actionid == 'quotation--detailq' ? $dasboard_f = 'active':$dasboard_f = '';
		  ?>
          <ul class="sidebar-menu">
            ...
            <li class="<?=$dasboard_b.$dasboard_c.$dasboard_d?> treeview">
			...
			<li class="<?=$dasboard_e.$dasboard_f?> treeview">
              ...
              <ul class="treeview-menu">
				...
				<li class="<?=$dasboard_f?>"><?php echo Html::a('<i class="fa fa-circle-o"></i> Quotation Detail',['/seaexport/quotation/detailq/',]);?></li>				
              </ul>
            </li>
