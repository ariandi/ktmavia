...
<div class="billlanding-form">
    ...
    <?php //echo $form->field($model, 'collect')->textInput(['maxlength' => true]) ?>
    ...
    <?php //echo $form->field($model, 'freight_charges')->textInput(['maxlength' => true]) ?>
    ...
    <?php //echo $form->field($model, 'exchange_rate')->textInput(['maxlength' => true]) ?>
