...
/* @var $searchModel backend\modules\seaimport\models\JobsheetSearch */
        ...
        'columns' => [
            ...
            'buttons' => [
                    'link' => function ($url,$data,$key) {
                            return Html::a('<span class="glyphicon glyphicon-th-list"></span>', ['/seaimport/jobsheetdet/detailq', 'id'=>$data->jobs_id]);
                    },
                    'view' => function ($url,$data){
                            $url = '/seaimport/jobsheet/jobsheetview/';
