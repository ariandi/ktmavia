...
/**
 * CreditnoteSearch represents the model behind the search form about `backend\modules\seaimport\models\Creditnote`.
 */
class CreditnoteSearch extends Creditnote
{
    ...
    {
        return [
            [['criditnote_id', 'bl_id', 'companyid', 'insert_by', 'update_by', 'active', 'invoice_id', 'kindofexport'], 'integer'],
