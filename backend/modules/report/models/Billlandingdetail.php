...
use Yii;
use backend\modules\report\models\Billlanding;
...
class Billlandingdetail extends \yii\db\ActiveRecord
{
	...
	public function getBillinfo()
    {
		...
		->leftJoin('company', 'bill_landing.shipper = company.companyid')
		->leftJoin('kindexport', 'bill_landing.kindofexport = kindexport.kindexport_id')
		;
